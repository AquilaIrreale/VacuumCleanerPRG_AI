...
def read_board(path: str):
    ...
    # TODO: improve
    cnts = sorted(cnts, key=lambda ctr: cv2.boundingRect(ctr)[0]**(3/2) + cv2.boundingRect(ctr)[1] * image.shape[0])
    ...
    for row in rooms_rows:
        for c in row:
            ...
            rooms_imgs.append(ROI)
    
    return rooms_imgs


if __name__ == "__main__":
    print(read_board('images/digital.jpg'))